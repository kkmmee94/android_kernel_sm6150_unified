...
# *KERNEL PATH*
# No need to edit CROSS_COMPILE area. Just Specify the Kernel
# Path in here and run the Make
...
ARCH		?= arm64
CROSS_COMPILE	?= $(KERNEL_PATH)/toolchain/aarch64-linux-android-4.9/bin/aarch64-linux-android-
